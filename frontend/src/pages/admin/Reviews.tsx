...
export default function Reviews() {
 ...
 return (
 <span className="font-medium text-text-primary" title={name}>
 ...
 header: 'Customer',
 accessor: (item: any) => (
 <span className="text-text-secondary" title={item.user_name || item.user_id}>
 ...
 <span className="font-medium text-text-primary">{item.rating}</span>
 </div>
 )
 },
 {
 ...
 <span className="px-2 py-1 bg-bg-secondary text-text-secondary dark:bg-bg-card dark:text-text-secondary text-xs rounded-full font-medium">Unverified</span>
 )
 )
 },
 {
 ...
 accessor: (item: any) => (
 item.status === 'HIDDEN'? (
 <span className="px-2 py-1 bg-bg-secondary text-text-secondary dark:bg-bg-card dark:text-text-secondary text-xs rounded-full font-medium">Hidden</span>
 ) : (
 ...
 <p className="mt-1 text-sm text-text-secondary">Manage and moderate product reviews.</p>
 </div>
 ...
 <select value={ratingFilter} onChange={e => setRatingFilter(e.target.value)} className="w-full rounded-lg border-border-subtle bg-bg-primary/50 text-text-primary">
 ...
 <select value={verifiedFilter} onChange={e => setVerifiedFilter(e.target.value)} className="w-full rounded-lg border-border-subtle bg-bg-primary/50 text-text-primary">
