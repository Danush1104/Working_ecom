...
export default function Payments() {
 ...
 header: 'Payment ID', 
 accessor: (item: any) => (
 <span className="font-medium text-text-primary" title={item.payment_id}>
 ...
 header: 'Order ID',
 accessor: (item: any) => (
 <span className="text-text-secondary" title={item.order_id}>
 ...
 <span className="text-text-primary font-medium" title={item.customer_username || item.user_id}>
 ...
 {item.customer_email && (
 <span className="text-xs text-text-secondary dark:text-text-secondary" title={item.customer_email}>
 ...
 {
 header: 'Method',
 accessor: (item: any) => <span className="text-text-secondary">{item.payment_method}</span>
 },
 { 
 header: 'Status', 
 ...
 <h1 className="text-2xl font-bold text-text-primary tracking-tight">Payments</h1>
 </div>
