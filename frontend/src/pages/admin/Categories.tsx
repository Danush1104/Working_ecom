...
export default function Categories() {
 ...
 <img src={item.icon_url} alt={item.name} className="w-10 h-10 rounded-full object-cover bg-bg-secondary dark:bg-bg-card" />
 ) : (
 ...
 { header: 'Name', accessor: (item: Category) => <span className="font-medium text-text-primary">{item.name}</span> },
 ...
 <p className="text-text-secondary dark:text-text-secondary mt-1">Manage product categories</p>
 </div>
 ...
 className="w-full rounded-lg border border-border-subtle dark:border-border-subtle bg-bg-secondary dark:bg-bg-primary px-4 py-2 outline-none focus:ring-1 focus:ring-primary dark:text-text-primary"
 >
 ...
 {totalPages > 1 && (
 <div className="px-6 py-4 border-t border-border-subtle dark:border-border-subtle flex justify-end">
 <Pagination 
 ...
 className="bg-bg-card  border border-border-subtle rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)] w-full max-w-md overflow-hidden"
 >
 <div className="flex items-center justify-between p-6 border-b border-border-subtle">
 <h2 className="text-xl font-space font-bold text-text-primary">
 ...
 {...register('name')}
 type="text"
 className="w-full px-4 py-2 bg-bg-secondary dark:bg-bg-primary border border-border-subtle dark:border-border-subtle rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent dark:text-text-primary"
 />
 ...
 type="button"
 onClick={closeModal}
 className="flex-1 px-4 py-2 bg-bg-secondary text-text-secondary rounded-xl hover:bg-bg-secondary dark:hover:bg-gray-600 transition-colors"
 >
 Cancel
 </button>
 <button
 ...
 className="flex-1 px-4 py-2 bg-primary text-text-primary rounded-xl hover:bg-primary-light transition-colors disabled:opacity-50"
 >
