...
export default function PaymentSuccess() {
 ...
 <h2 className="text-xl font-bold text-text-primary mb-2">Error Loading Details</h2>
 <p className="text-text-secondary dark:text-text-secondary mb-6">We could not load your payment success details.</p>
 <button 
 ...
 <h2 className="text-xl font-bold text-text-primary mb-2">Payment Not Completed</h2>
 ...
 <span className="font-medium text-text-primary sm:col-span-2">{payment.payment_method}</span>
 </div>
 </div>
 ...
 <button 
 onClick={() => navigate('/')}
 className="px-6 py-3 bg-bg-secondary dark:bg-bg-card text-text-primary rounded-xl font-medium hover:bg-bg-secondary transition-colors"
 >
 Continue Shopping
 </button>
 </div>
