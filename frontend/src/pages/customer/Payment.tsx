...
export default function Payment() {
 ...
 <h2 className="text-xl font-bold text-text-primary mb-2">Order Not Found</h2>
 <p className="text-text-secondary dark:text-text-secondary">We could not find the order you are trying to pay for.</p>
 </div>
 );
 }
 ...
 >
 <div className="bg-bg-card dark:bg-bg-card p-8 rounded-3xl shadow-soft border border-border-subtle dark:border-border-subtle">
 <div className="text-center mb-8">
 <div className="w-16 h-16 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-4">
 <CreditCard className="w-8 h-8" />
 </div>
 <h1 className="text-2xl font-bold text-text-primary mb-2">Complete Payment</h1>
 <p className="text-text-secondary dark:text-text-secondary text-sm">Order {order.order_id}</p>
 </div>

 <div className="space-y-4 mb-8">
 <div className="flex justify-between py-3 border-b border-border-subtle dark:border-border-subtle">
 <span className="text-text-secondary dark:text-text-secondary">Total Amount</span>
 <span className="font-semibold text-text-primary">{formatCurrency(order.total_amount)}</span>
 </div>
 <div className="flex justify-between py-3 border-b border-border-subtle dark:border-border-subtle">
 <span className="text-text-secondary dark:text-text-secondary">Payment Method</span>
 <span className="font-semibold text-text-primary">{order.payment_method}</span>
 </div>
 </div>
 ...
 className="w-full h-14 bg-bg-secondary dark:bg-bg-card text-text-secondary rounded-xl font-semibold hover:bg-bg-secondary active:scale-[0.98] transition-all"
 >
 Cancel Payment
 </button>
 </div>
 
 <div className="mt-6 flex items-center justify-center gap-2 text-sm text-text-secondary dark:text-text-secondary">
