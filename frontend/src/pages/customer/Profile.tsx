      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              {isLoadingOrders ? (
                ...
                <div className="py-8 text-center border border-dashed border-red-200 dark:border-red-900/50 rounded-2xl bg-red-50/50 dark:bg-red-900/10">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Failed to load recent orders.</p>
                </div>
              ) : recentOrders.length === 0 ? (
                <div className="py-8 border border-dashed border-gray-200 dark:border-gray-700 rounded-2xl">
                  <EmptyState 
                    icon={Package}
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <Link to="/wishlist" className="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-gray-800 dark:to-gray-800 p-6 rounded-3xl border border-pink-200 dark:border-gray-700 hover:shadow-md transition-all group">
              <Heart className="h-8 w-8 text-pink-500 mb-4 group-hover:scale-110 transition-transform" fill="currentColor" />
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">My Wishlist</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">View saved items</p>
            </Link>
            
            <Link to="/settings" className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-800 p-6 rounded-3xl border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all group">
              <Settings className="h-8 w-8 text-gray-500 dark:text-gray-400 mb-4 group-hover:rotate-45 transition-transform duration-300" />
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Account Settings</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Manage your password & details</p>
            </Link>
          </div>
        </div>
