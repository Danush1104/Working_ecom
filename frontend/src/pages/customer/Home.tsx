    ...
    >
      ...
      <section className="py-4 min-h-[500px]">
        ...
        {isLoading ? (
          ...
          >
            <p className="text-gray-400 font-medium text-lg">No products found matching your filters.</p>
            <button 
      ...
      <section className="py-16 border-t border-white/5">
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-gray-400 font-medium">Real feedback from the STOREFRONT community.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {activeReviews.map((review, idx) => (
              ...
              >
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex text-yellow-400 mt-1">
                        {[1, 2, 3, 4, 5].map(star => (
                          <Star key={star} className={`h-3 w-3 ${star <= review.rating ? 'fill-current' : 'text-gray-700'}`} />
                        ))}
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t border-white/5 text-[11px] font-medium text-gray-500">
