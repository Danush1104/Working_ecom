...
export default function Login() {
 ...
 <div className="w-full max-w-[440px] bg-bg-card rounded-[24px] p-8 sm:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-border-subtle relative">
 ...
 {...register('email')}
 type="email"
 className="w-full h-12 pl-11 pr-4 bg-bg-card rounded-xl border border-border-subtle text-text-primary text-[15px] focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all placeholder:text-text-secondary"
 ...
 className="w-full h-12 pl-11 pr-11 bg-bg-card rounded-xl border border-border-subtle text-text-primary text-[15px] focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all placeholder:text-text-secondary"
 placeholder="Enter your password"
 />
 <button
 type="button"
 onClick={() => setShowPassword(!showPassword)}
 className="absolute inset-y-0 right-0 pr-4 flex items-center text-text-secondary hover:text-text-secondary transition-colors"
 >
 {showPassword ? (
