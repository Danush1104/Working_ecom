    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-bg-card/40 backdrop-blur-xl p-3 rounded-2xl shadow-soft border border-border-subtle mb-6">
      <div className="relative w-full sm:w-80 flex-1">
        ...
        <input 
          ...
          className="h-10 w-full rounded-xl border border-border-subtle bg-bg-primary/50 pl-10 pr-4 text-sm text-white placeholder-text-secondary/50 outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all shadow-inner"
        />
      </div>
      <div className="flex w-full sm:w-auto items-center gap-2 flex-wrap sm:flex-nowrap">
        <button 
          onClick={onFilterClick}
          className="flex-1 sm:flex-none flex items-center justify-center gap-2 h-10 px-4 rounded-xl border border-border-subtle text-text-secondary hover:text-white hover:bg-white/5 hover:border-white/20 transition-all text-sm font-medium focus:outline-none"
        >
