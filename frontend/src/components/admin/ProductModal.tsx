...
export function ProductModal({ isOpen, onClose, onSave, initialData, title ="Add Product" }: ProductModalProps) {
 ...
 className="relative w-full max-w-2xl bg-bg-card rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-border-subtle overflow-hidden flex flex-col max-h-full"
 >
 <div className="flex items-center justify-between px-6 py-6 border-b border-border-subtle">
 <h2 className="text-2xl font-space font-bold text-text-primary tracking-tight">{title}</h2>
 <button 
 onClick={onClose}
 className="p-2 text-text-secondary hover:text-text-primary hover:bg-bg-secondary rounded-full transition-colors focus:outline-none"
 >
 <X className="h-5 w-5" />
 </button>
 </div>
 ...
 className="w-full h-11 px-4 rounded-xl border border-border-subtle bg-bg-secondary text-text-primary focus:border-primary/50 focus:ring-1 focus:ring-primary/50 outline-none transition-all shadow-inner placeholder-text-secondary/70"
 ...
 className="w-full p-4 rounded-xl border border-border-subtle bg-bg-secondary text-text-primary focus:border-primary/50 focus:ring-1 focus:ring-primary/50 outline-none transition-all resize-none shadow-inner placeholder-text-secondary/70"
 ...
 className="w-full h-11 px-4 rounded-xl border border-border-subtle bg-bg-secondary text-text-primary focus:border-primary/50 focus:ring-1 focus:ring-primary/50 outline-none transition-all shadow-inner"
 >
 ...
 className="w-full h-11 pl-8 pr-4 rounded-xl border border-border-subtle bg-bg-secondary text-text-primary focus:border-primary/50 focus:ring-1 focus:ring-primary/50 outline-none transition-all shadow-inner placeholder-text-secondary/70"
 placeholder="0.00"
 />
 </div>
 </div>
 ...
 type="button"
 onClick={onClose}
 className="px-6 h-11 rounded-xl font-medium text-text-secondary bg-bg-primary border border-border-subtle hover:text-text-primary transition-colors focus:outline-none"
 >
 Cancel
 </button>
 <motion.button 
