    ...
    <div className="relative group w-full py-4">
      ...
      <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-bg-primary via-bg-primary/80 to-transparent z-10 flex items-center pointer-events-none">
        <button 
          ...
          className="ml-2 w-10 h-10 rounded-full bg-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center text-white hover:bg-white/10 hover:border-primary/50 transition-all pointer-events-auto opacity-0 group-hover:opacity-100 shadow-[0_0_15px_rgba(34,211,238,0.2)]"
        >
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center gap-3 min-w-[100px] shrink-0 p-3 rounded-2xl transition-all duration-300 focus:outline-none ${
                isActive 
                  ? 'bg-white/5 border border-primary/30 shadow-[0_0_20px_rgba(21,216,255,0.15)] scale-105' 
            ...
            >
              ...
              <div className={`w-16 h-16 rounded-full overflow-hidden p-0.5 transition-all duration-300 ${
                isActive ? 'bg-gradient-to-tr from-primary to-purple-500 shadow-[0_0_15px_rgba(21,216,255,0.4)]' : 'bg-white/10 group-hover:bg-white/20'
              }`}>
                <div className="w-full h-full rounded-full overflow-hidden bg-bg-card flex items-center justify-center">
                  {cat.icon_url ? (
                    ...
                    <ShoppingBag className={`w-6 h-6 ${isActive ? 'text-cyan-400' : 'text-gray-500'} group-hover:scale-110 transition-transform duration-500`} />
                  )}
                </div>
              </div>
      ...
      <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-bg-primary via-bg-primary/80 to-transparent z-10 flex items-center justify-end pointer-events-none">
        <button 
          ...
          className="mr-2 w-10 h-10 rounded-full bg-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center text-white hover:bg-white/10 hover:border-primary/50 transition-all pointer-events-auto opacity-0 group-hover:opacity-100 shadow-[0_0_15px_rgba(34,211,238,0.2)]"
        >
