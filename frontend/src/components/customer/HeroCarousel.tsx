...
export function HeroCarousel() {
  ...
  return (
    <div className="relative h-[60vh] sm:h-[70vh] w-full overflow-hidden rounded-[32px] group bg-bg-card">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-8 sm:px-16 lg:px-24">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-300 font-medium max-w-lg leading-relaxed drop-shadow-md">
