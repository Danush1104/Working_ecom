...
def handle(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    Handler for PATCH /api/inventory/release.
    Releases stock reservation for a product.
    """
    ...
    inventory_data = service.release_stock(product_id, quantity, event_id=correlation_id)
