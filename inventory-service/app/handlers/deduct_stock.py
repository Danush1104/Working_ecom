...
def handle(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    Handler for PATCH /api/inventory/deduct.
    Deducts stock (reduces total stock and reserved stock level).
    """
    ...
    inventory_data = service.deduct_stock(product_id, quantity, event_id=correlation_id)
